...
public class TestPoint2D {
    public static void main(String[] args) {
        ...
        System.out.printf("The initial value of p1 is: %s\n",p1);
        System.out.printf("Is p1 at the origin?: %s\n",p1.isOrigin());
        System.out.println("Asking user to change values of p1!");
        p1.input();
        System.out.printf("The new value of p1: %s\n",p1);
        Point2D p2 = new Point2D(4,7);
        System.out.printf("The value of p2 is: %s\n",p2);
        Point2D p3 = new Point2D(p2);
        System.out.printf("The value of p3 is: %s\n",p3);
