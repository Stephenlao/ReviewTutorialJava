package week8.question1andquestion2;
...
public class mainQ1andQ2 {
    ...
    public static void main(String[] args) throws IOException {
        PrintWriter pw = new PrintWriter(new FileWriter("src/week8/question1/users.txt"));
        ...
        Scanner fileScanner = new Scanner(new File("src/week8/question1/users.txt"));
